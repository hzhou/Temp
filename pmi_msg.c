...
int PMIU_msg_cmd_to_id(const char *cmd)
{
    ...
    } else if (strcmp(cmd, "job-getid") == 0) {
        return PMIU_CMD_JOBID;
...
const char *PMIU_msg_id_to_response(int version, int cmd_id)
{
    switch(cmd_id) {
        ...
        case PMIU_CMD_SPAWN:
            return (version == PMIU_WIRE_V1) ? "spawn_result" : "spawn_response";
        case PMIU_CMD_SINGINIT:
...
int PMIU_msg_get_response_fullinit(struct PMIU_cmd *pmi, int *rank, int *size, int *appnum, const char **spawner_jobid, int *debug)
{
    ...
    if (pmi->version == PMIU_WIRE_V1) {
        ...
        PMIU_CMD_GET_STRVAL_WITH_DEFAULT(pmi, "spawner-jobid", *spawner_jobid, "");
...
int PMIU_msg_get_query_abort(struct PMIU_cmd *pmi, int *exitcode, const char **message)
{
    ...
    PMIU_CMD_GET_STRVAL_WITH_DEFAULT(pmi, "message", *message, "");
...
int PMIU_msg_get_query_get(struct PMIU_cmd *pmi, const char **kvsname, const char **key)
{
    ...
    PMIU_CMD_GET_STRVAL_WITH_DEFAULT(pmi, "kvsname", *kvsname, "");
    PMIU_CMD_GET_STRVAL(pmi, "key", *key);
...
int PMIU_msg_set_response_spawn(struct PMIU_cmd *pmi_query, struct PMIU_cmd *pmi_resp, bool is_static, const char *errcodes)
{
    int pmi_errno = PMIU_SUCCESS;

    PMIU_Assert(pmi_query->cmd_id == PMIU_CMD_SPAWN);
    pmi_errno = PMIU_msg_set_response(pmi_query, pmi_resp, is_static);
    PMIU_cmd_add_str(pmi_resp, "errcodes", errcodes);

    return pmi_errno;
}

int PMIU_msg_get_response_spawn(struct PMIU_cmd *pmi, const char **errcodes)
{
    int pmi_errno = PMIU_SUCCESS;

    PMIU_CMD_GET_STRVAL_WITH_DEFAULT(pmi, "errcodes", *errcodes, "");
...
int PMIU_msg_set_response_jobid(struct PMIU_cmd *pmi_query, struct PMIU_cmd *pmi_resp, bool is_static, const char *jobid)
{
    int pmi_errno = PMIU_SUCCESS;

    PMIU_Assert(pmi_query->cmd_id == PMIU_CMD_JOBID);
    pmi_errno = PMIU_msg_set_response(pmi_query, pmi_resp, is_static);
    PMIU_cmd_add_str(pmi_resp, "jobid", jobid);

    return pmi_errno;
}

int PMIU_msg_get_response_jobid(struct PMIU_cmd *pmi, const char **jobid)
{
    int pmi_errno = PMIU_SUCCESS;
...
int PMIU_msg_get_query_getnodeattr(struct PMIU_cmd *pmi, const char **key, bool *wait)
{
    ...
    PMIU_CMD_GET_STRVAL(pmi, "key", *key);
    PMIU_CMD_GET_BOOLVAL(pmi, "wait", *wait);
...
int PMIU_msg_get_query_kvsget(struct PMIU_cmd *pmi, const char **jobid, int *srcid, const char **key)
{
    ...
    PMIU_CMD_GET_STRVAL_WITH_DEFAULT(pmi, "jobid", *jobid, "");
...
int PMIU_msg_set_response_kvsget(struct PMIU_cmd *pmi_query, struct PMIU_cmd *pmi_resp, bool is_static, const char *value)
{
    int pmi_errno = PMIU_SUCCESS;
...
int PMIU_msg_get_response_kvsget(struct PMIU_cmd *pmi, const char **value)
{
    int pmi_errno = PMIU_SUCCESS;
